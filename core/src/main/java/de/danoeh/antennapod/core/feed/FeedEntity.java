...
public class FeedEntity extends FeedFile implements ImageResource {
     ...
     */
    @ColumnInfo(name = "feed_identifier")
     ...
     * logical feed.
     */
    @ColumnInfo(name = "is_paged", defaultValue = "0")
     ...
     */
    @ColumnInfo(name = "next_page_link")
    ...
    static class FeedItemFilterConverter {
        ...
        public static String toString(FeedItemFilter itemFilter) {
            if (itemFilter != null && itemFilter.getValues().length > 0) {
                return TextUtils.join(",", itemFilter.getValues());
            } else {
                return "";
            }
        }
        ...
        @TypeConverter
        public static FeedItemFilter toFeedItemFilter(String filter) {
            return filter == null ? null : new FeedItemFilter(filter);
        }
    }
    ...
    static class SortOrderConverter {
        ...
        public static SortOrder toSortOrder(String sortOrder) {
            return SortOrder.fromCodeString(sortOrder);
        }
    }
    ...
    public void setItemFilter(FeedItemFilter itemFilter) {
