...
@Database(entities = [FeedEntity::class, FeedItemEntity::class, FeedMedia::class, DownloadStatus::class, QueueEntity::class, Chapter::class, FavoritesEntity::class], version = 1070403)
